...
function normalizeProfileLocation(body: {
  latitude?: unknown;
  longitude?: unknown;
  placeId?: unknown;
}) {
...
export async function updateProfile(req: Request, res: Response) {
  try {
    ...
    if (
      ...
      const normalizedLocation = normalizeProfileLocation({
        latitude,
        longitude,
        placeId,
      });

      user.latitude = normalizedLocation.latitude;
      user.longitude = normalizedLocation.longitude;
      user.placeId = normalizedLocation.placeId;
    }
